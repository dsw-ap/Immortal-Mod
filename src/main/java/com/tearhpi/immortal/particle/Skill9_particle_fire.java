...
public class Skill9_particle_fire extends TextureSheetParticle {
    private final SpriteSet sprites;

    public Skill9_particle_fire(ClientLevel level, double x, double y, double z,
                                double vx, double vy, double vz, SpriteSet sprites) {
        super(level, x, y, z, vx, vy, vz);
        this.sprites = sprites;
        this.setSpriteFromAge(sprites);
        this.lifetime = 10 + this.random.nextInt(8); // 10~17 tick
        this.gravity = 0.0F;
