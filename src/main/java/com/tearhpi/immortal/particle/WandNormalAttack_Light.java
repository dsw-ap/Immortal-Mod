...
public class WandNormalAttack_Light extends TextureSheetParticle {
    private final SpriteSet sprites;

    public WandNormalAttack_Light(ClientLevel level, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level,
            ...
            return new WandNormalAttack_Light(level, x, y, z, vx, vy, vz, sprites);
        }
    }
}
