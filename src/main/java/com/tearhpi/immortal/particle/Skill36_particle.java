...
public class Skill36_particle extends TextureSheetParticle {
    ...
    protected Skill36_particle(ClientLevel level, double x, double y, double z, OrbitParticleAir opts, SpriteSet sprites) {
    ...
    public static class OrbitParticleProvider implements ParticleProvider<OrbitParticleAir> {
        private final SpriteSet sprites;
        public OrbitParticleProvider(SpriteSet sprites) { this.sprites = sprites; }

        @Override
        public Particle createParticle(OrbitParticleAir opts, ClientLevel level, double x, double y, double z, double vx, double vy, double vz) {
            return new Skill36_particle(level, x, y, z, opts, sprites);
        }
    }
}
