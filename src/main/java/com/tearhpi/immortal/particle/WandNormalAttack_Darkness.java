...
public class WandNormalAttack_Darkness extends TextureSheetParticle {
    private final SpriteSet sprites;

    public WandNormalAttack_Darkness(ClientLevel level, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level,
            ...
            return new WandNormalAttack_Darkness(level, x, y, z, vx, vy, vz, sprites);
        }
    }
}
