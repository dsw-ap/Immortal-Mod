...
public class Skill48_particle extends TextureSheetParticle {
    ...
    protected Skill48_particle(ClientLevel level, double x, double y, double z, OrbitParticleEarth opts, SpriteSet sprites) {
    ...
    public static class OrbitParticleProvider implements ParticleProvider<OrbitParticleEarth> {
        private final SpriteSet sprites;
        public OrbitParticleProvider(SpriteSet sprites) { this.sprites = sprites; }

        @Override
        public Particle createParticle(OrbitParticleEarth opts, ClientLevel level, double x, double y, double z, double vx, double vy, double vz) {
            return new Skill48_particle(level, x, y, z, opts, sprites);
        }
    }
}
