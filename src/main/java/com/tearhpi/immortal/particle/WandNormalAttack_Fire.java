...
public class WandNormalAttack_Fire extends TextureSheetParticle {
    private final SpriteSet sprites;

    public WandNormalAttack_Fire(ClientLevel level, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level,
            ...
            return new WandNormalAttack_Fire(level, x, y, z, vx, vy, vz, sprites);
        }
    }
}
