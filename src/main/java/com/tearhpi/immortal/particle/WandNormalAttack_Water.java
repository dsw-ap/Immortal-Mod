...
public class WandNormalAttack_Water extends TextureSheetParticle {
    private final SpriteSet sprites;

    public WandNormalAttack_Water(ClientLevel level, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level,
            ...
            return new WandNormalAttack_Water(level, x, y, z, vx, vy, vz, sprites);
        }
    }
}
