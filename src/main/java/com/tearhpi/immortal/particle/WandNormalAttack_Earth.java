...
public class WandNormalAttack_Earth extends TextureSheetParticle {
    private final SpriteSet sprites;

    public WandNormalAttack_Earth(ClientLevel level, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level,
            ...
            return new WandNormalAttack_Earth(level, x, y, z, vx, vy, vz, sprites);
        }
    }
}
