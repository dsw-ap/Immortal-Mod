...
public class _AIR extends TextureSheetParticle {
    private final SpriteSet sprites;
    protected _AIR(ClientLevel p_107631_, double p_107632_, double p_107633_, double p_107634_, double p_107635_, double p_107636_, double p_107637_, SpriteSet sprites) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level,
            ...
            return new _AIR(level, x, y, z, vx, vy, vz,sprites);
        }
    }
}
