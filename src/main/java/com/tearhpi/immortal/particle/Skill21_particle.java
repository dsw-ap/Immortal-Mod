...
public class Skill21_particle extends TextureSheetParticle {
    ...
    protected Skill21_particle(ClientLevel level, double x, double y, double z, OrbitParticleWater opts, SpriteSet sprites) {
    ...
    public static class OrbitParticleProvider implements ParticleProvider<OrbitParticleWater> {
        private final SpriteSet sprites;
        public OrbitParticleProvider(SpriteSet sprites) { this.sprites = sprites; }

        @Override
        public Particle createParticle(OrbitParticleWater opts, ClientLevel level, double x, double y, double z, double vx, double vy, double vz) {
            return new Skill21_particle(level, x, y, z, opts, sprites);
        }
    }
}
