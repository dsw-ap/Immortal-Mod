...
public class Skill55_particle extends TextureSheetParticle {
    ...
    protected Skill55_particle(ClientLevel level, double x, double y, double z, OrbitParticleLight opts, SpriteSet sprites) {
    ...
    public static class OrbitParticleProvider implements ParticleProvider<OrbitParticleLight> {
        private final SpriteSet sprites;
        public OrbitParticleProvider(SpriteSet sprites) { this.sprites = sprites; }

        @Override
        public Particle createParticle(OrbitParticleLight opts, ClientLevel level, double x, double y, double z, double vx, double vy, double vz) {
            return new Skill55_particle(level, x, y, z, opts, sprites);
        }
    }
}
