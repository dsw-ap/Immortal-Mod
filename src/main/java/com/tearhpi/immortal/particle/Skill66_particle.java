...
public class Skill66_particle extends TextureSheetParticle {
    ...
    protected Skill66_particle(ClientLevel level, double x, double y, double z, OrbitParticleDarkness opts, SpriteSet sprites) {
    ...
    public static class OrbitParticleProvider implements ParticleProvider<OrbitParticleDarkness> {
        private final SpriteSet sprites;
        public OrbitParticleProvider(SpriteSet sprites) { this.sprites = sprites; }

        @Override
        public Particle createParticle(OrbitParticleDarkness opts, ClientLevel level, double x, double y, double z, double vx, double vy, double vz) {
            return new Skill66_particle(level, x, y, z, opts, sprites);
        }
    }
}
