...
public class Weapon_2_4 extends WandItem {
    private static final String TAG_CD = "Weapon2_4_cd";

    public Weapon_2_4(WeaponItemProperties p_41383_, int weapon_level, int weapon_type, WeaponAttributeAttack weaponAttributeAttack) {
