...
public class Weapon_2_2 extends WandItem {
    public Weapon_2_2(WeaponItemProperties p_41383_, int weapon_level, int weapon_type, WeaponAttributeAttack weaponAttributeAttack) {
    ...
    public void inventoryTick(ItemStack stack, Level level, Entity entity, int slot, boolean selected) {
        ...
        //夯岩
        if (true) {
            ImposeEffect.ImposeEffectWithoutAmp(player, _ModEffects.WEAPON2_2_EFFECT.get(), 30);
        }
        //庇护
        if (true) {
            double r = 7.0f;
            ...
            for (Player p : player_List) {
                ImposeEffect.ImposeEffectWithoutAmp(p, _ModEffects.WEAPON2_2_EFFECT_.get(), 30);
            }
        }
    }
}
