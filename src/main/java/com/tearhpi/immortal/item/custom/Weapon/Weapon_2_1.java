...
public class Weapon_2_1 extends WandItem {
    private static final String TAG_CD = "Weapon2_1_cd";

    public Weapon_2_1(WeaponItemProperties p_41383_, int weapon_level, int weapon_type, WeaponAttributeAttack weaponAttributeAttack) {
