...
import com.tearhpi.immortal.block.geo.render.GildedTableItemRenderer;
...
public class GildedTableItem extends BlockItem implements GeoItem {
    public GildedTableItem(Block p_40565_, Properties p_40566_) {
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        consumer.accept(new IClientItemExtensions() {
            private GildedTableItemRenderer renderer;

            @Override
            public BlockEntityWithoutLevelRenderer getCustomRenderer() {
                if (this.renderer == null) {
                    this.renderer = new GildedTableItemRenderer();
                }
