...
public class utilBookArrowButton extends StateSwitchingButton {
    public int max_width;
    public int max_height;
    public boolean isHovering;
    public utilBookArrowButton(int p_94615_, int p_94616_, int p_94617_, int p_94618_, boolean p_94619_, int max_width, int max_height) {
