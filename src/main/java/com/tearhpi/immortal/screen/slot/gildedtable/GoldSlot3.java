...
public class GoldSlot3 extends LockableSlot {
    public GoldSlot3(IItemHandler itemHandler, int index, int xPosition, int yPosition, Supplier<Boolean> isLocked) {
        super(itemHandler, index, xPosition, yPosition,isLocked);
    }
    @Override
    public boolean mayPlace(@NotNull ItemStack stack) {
        return (stack.getItem().equals(WeaponAddonRegister.GoldType3.get()) && (!isLocked.get()));
    }
}
