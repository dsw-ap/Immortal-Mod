...
public class GoldSlot2 extends LockableSlot {
    public GoldSlot2(IItemHandler itemHandler, int index, int xPosition, int yPosition, Supplier<Boolean> isLocked) {
        super(itemHandler, index, xPosition, yPosition,isLocked);
    }
    @Override
    public boolean mayPlace(@NotNull ItemStack stack) {
        return (stack.getItem().equals(WeaponAddonRegister.GoldType2.get()) && (!isLocked.get()));
    }
}
